...
static const VerifyStep s_continuity[] = {
  { STEP_SAFETY, "Safety", "Zero or compensate test leads so lead resistance is excluded. Use leads and instrument suitable for the circuit voltage.", "3000:2018 Sec 8; 3017:2022", RESULT_NONE, NULL, NULL },
  ...
  { STEP_VERIFY_YESNO, "Isolation", "Is the circuit isolated from supply before testing?", "3000:2018 Cl.8.3", RESULT_NONE, NULL, NULL },
...
static const VerifyStep s_insulation[] = {
  { STEP_SAFETY, "Safety", "Do not touch live parts. Use 500 V DC rated leads where required. Isolate the circuit and disconnect electronic loads as applicable.", "3000:2018 Sec 8; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "IR test", "Insulation resistance is per 3000:2018 Cl.8.3.6; apply test voltage and stabilise reading per 3017:2022 and manufacturer instructions.", "3000:2018 Cl.8.3.6; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Isolation", "Is the circuit isolated and loads disconnected as required for the IR test?", "3000:2018 Cl.8.3.6", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Sheathed heating", "Is this for sheathed heating elements? (Lower minimum IR applies.)", "3000:2018 Cl.8.3.6", RESULT_NONE, NULL, NULL },
  { STEP_RESULT_ENTRY, "Insulation resistance", "Enter IR in MOhm. General wiring: min 1 MOhm; sheathed heating path: min 0.01 MOhm (app applies correct limit).", "3000:2018 Cl.8.3.6; 3017:2022", RESULT_IR_MOHM, "Insulation resistance", "MOhm" },
};
...
static const VerifyStep s_polarity[] = {
  ...
  { STEP_INFO, "Polarity check", "Verify at every relevant point that active and neutral are not transposed (3000:2018 Cl.8.3.7).", "3000:2018 Cl.8.3.7", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Isolation", "Is the circuit isolated from supply for your test method?", "3000:2018 Cl.8.3", RESULT_NONE, NULL, NULL },
...
static const VerifyStep s_earth_continuity[] = {
  { STEP_SAFETY, "Safety", "Zero leads, isolate supply, confirm CPC continuity path is the one under test.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "CPC test", "Measure circuit protective conductor (CPC) resistance per 3000:2018 Cl.8.3.5 after lead compensation.", "3000:2018 Cl.8.3.5", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Isolation", "Is the circuit isolated from supply?", "3000:2018 Cl.8.3", RESULT_NONE, NULL, NULL },
...
static const VerifyStep s_efli[] = {
  ...
  { STEP_INFO, "Zs criterion", "Obtain the maximum permitted earth-fault loop impedance (Zs) for this circuit from 3000:2018 / installation design. App compares to a configurable default (see Admin rules).", "3000:2018 Cl.8.3.9; Appendix", RESULT_NONE, NULL, NULL },
...
static const VerifyStep s_rcd[] = {
  { STEP_SAFETY, "Safety", "RCD test may de-energise circuits. Warn occupants; avoid critical loads. Use RCD tester per manufacturer.", "3000:2018 Cl.8.3.10; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Test current", "Apply test current appropriate to the RCD type and rating (often 1x IΔn for time test). Follow 3017:2022 and tester instructions.", "3017:2022; 3000:2018 Cl.8.3.10", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Ready to test", "Is the RCD tester connected correctly and the circuit energised where required?", "3000:2018 Cl.8.3.10", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Installation context", "Confirm required RCD type, rating, and maximum disconnection time per 3000:2018 Cl.2.6 and any special-location rules (e.g. medical).", "3000:2018 Cl.2.6; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Requirements confirmed", "Have you identified the required maximum trip/disconnection time for this installation?", "3000:2018 Cl.2.6; 3017:2022", RESULT_NONE, NULL, NULL },
...
static const VerifyStep s_swp_motor[] = {
  { STEP_SAFETY, "Start safe", "Wear PPE, control hazards, and notify nearby people before starting motor disconnect/reconnect work.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Prepare tools", "Confirm approved voltage tester, continuity tester, IR tester, insulated tools, lock, and DANGER tags are ready.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Tester battery/check", "Check tester body/leads/fuse for damage and confirm battery/self-test is OK before use.", "4836:2023", RESULT_NONE, NULL, NULL },
  ...
  { STEP_INFO, "Disconnect and label", "Disconnect motor conductors and label each wire/terminal (photo or tags) to prevent reconnection errors.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Reconnect wiring", "Reconnect wires to correct terminals from manufacturer wiring diagram. Tighten all terminals securely.", "3000:2018 Sec 8", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Zero continuity leads", "Zero/compensate continuity leads before measuring. Confirm lead-zero value is stable.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Earth continuity check", "Measure continuity from known earth to motor frame. State reading and units clearly.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Insulation resistance check", "If required, perform IR test and record reading with units and pass criterion.", "3000:2018 Cl.8.3.6; 3017:2022", RESULT_NONE, NULL, NULL },
  ...
  { STEP_INFO, "Reassemble safely", "Refit covers/guards, check no tools left inside, and confirm terminals are protected.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Restore supply control", "Warn personnel, remove lock/tag only when safe and authorised, then restore supply.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Final motor check", "Did motor start and run correctly with no abnormal heat, sound, smell, or vibration?", "4836:2023", RESULT_NONE, NULL, NULL },
};

static const VerifyStep s_swp_appliance[] = {
  { STEP_SAFETY, "Start safe", "Wear PPE, control hazards, and notify nearby people before starting appliance disconnect/reconnect work.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Prepare tools", "Confirm approved voltage tester, continuity tester, IR tester, insulated tools, lock, and DANGER tags are ready.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Tester battery/check", "Check tester body/leads/fuse for damage and confirm battery/self-test is OK before use.", "4836:2023", RESULT_NONE, NULL, NULL },
  ...
  { STEP_INFO, "Disconnect and label", "Disconnect appliance wiring and label each conductor/terminal before reconnection.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Reconnect wiring", "Reconnect as per manufacturer diagram and check terminal tightness.", "3000:2018 Sec 8", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Zero continuity leads", "Zero/compensate continuity leads before testing earth continuity.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Earth continuity check", "Measure continuity from known earth to appliance frame and state reading with units.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Insulation resistance check", "Run IR test live-to-earth/frame and record reading, units, and pass criterion.", "3000:2018 Cl.8.3.6; 3017:2022", RESULT_NONE, NULL, NULL },
  ...
  { STEP_INFO, "Reassemble safely", "Secure covers and cable clamps/strain relief. Confirm no exposed live parts.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Restore supply control", "Warn personnel, remove lock/tag only when safe and authorised, then restore supply.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Final appliance check", "Is appliance operating correctly and safely with no abnormal heat, smell, noise, or faults?", "4836:2023", RESULT_NONE, NULL, NULL },
};

static const VerifyStep s_swp_heater_sheathed[] = {
  { STEP_SAFETY, "Start safe", "Wear PPE, control hazards, and notify people before working on heater/sheathed element circuit.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Prepare tools", "Confirm approved voltage tester, continuity tester, IR tester, insulated tools, lock, and DANGER tags are ready.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Tester battery/check", "Check tester body/leads/fuse for damage and confirm battery/self-test is OK before use.", "4836:2023", RESULT_NONE, NULL, NULL },
  ...
  { STEP_INFO, "Disconnect and label", "Disconnect element wiring and label wires/terminals before reconnecting.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Reconnect wiring", "Reconnect heater/sheathed element wiring to correct terminals and tighten securely.", "3000:2018 Sec 8", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Zero continuity leads", "Zero/compensate continuity leads before continuity measurement.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Earth continuity check", "Measure continuity from known earth to frame/sheath and state reading with units.", "3000:2018 Cl.8.3.5; 3017:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Insulation resistance check", "Perform IR test and record reading with units. For sheathed heating, apply required minimum criterion for this installation.", "3000:2018 Cl.8.3.6; 3017:2022", RESULT_NONE, NULL, NULL },
  ...
  { STEP_INFO, "Reassemble safely", "Refit all covers and verify no exposed live parts remain.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Restore supply control", "Warn personnel, remove lock/tag only when safe and authorised, then restore supply.", "4836:2023", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Final heater check", "Does heater/sheathed element operate correctly and safely with no abnormal condition?", "4836:2023", RESULT_NONE, NULL, NULL },
};

/** In-service checklist (training aid — use site test sheets for tabulated limits). */
static const VerifyStep s_pat_3760[] = {
  { STEP_SAFETY, "Safety", "Isolate or disconnect equipment per site procedure before inspection. Use appropriate PPE and test instruments.", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Scope", "This guide aligns with AS/NZS 3760:2022 in-service safety inspection. Follow your employer forms for exact limits and test types.", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Visual inspection", "Inspect flexible cords, plugs, guards, housings, and labels for damage, overheating signs, and strain.", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Visual outcome", "Is the item free from visible damage or defects that would make it unsafe?", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Test selection", "Class I earthed items need protective earth continuity where applicable; Class II is double-insulated. Add IR/leakage per your procedure.", "3760:2022; 3000:2018 Sec 8", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Electrical tests", "Have required electrical tests been completed with PASS results per your 3760 procedure?", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_INFO, "Operation", "Where safe, operate the equipment and watch for abnormal heat, noise, smell, or malfunction.", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Operation OK", "Does the item operate normally with no hazardous fault indication?", "3760:2022", RESULT_NONE, NULL, NULL },
  { STEP_VERIFY_YESNO, "Records", "Is documentation complete and the item cleared as safe for continued use (tag/record as required)?", "3760:2022", RESULT_NONE, NULL, NULL },
};
...
const char* VerificationSteps_getClauseForResult(VerifyResultKind kind) {
  switch (kind) {
    ...
    case RESULT_IR_MOHM:
    case RESULT_IR_MOHM_SHEATHED: return "AS/NZS 3000:2018 Cl.8.3.6; AS/NZS 3017:2022";
